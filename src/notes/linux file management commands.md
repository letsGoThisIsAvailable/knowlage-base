...
**chmod ___  ______** - change file permission by entering the following  first arguments:
...
**ls -la** -show hidden files in the current directory. The thing it says before file name are:
file types:
*-* > file
*d* > directory
permissions:
